...
const stats = [
  ...
  { value: "+700", label: "مسافر خدمناهم" },
  { value: "24/7", label: "دعم بالهاتف وواتساب" },
  { value: "طرابلس", label: "المكتب الرئيسي" },
];
...
const steps = [
  {
    n: "1",
    title: "قل لنا وجهتك",
    desc: "الوجهة والمدة والميزانية ونوع الرحلة.",
    highlight: false,
  },
  {
    n: "2",
    title: "نجهّز المستندات",
    desc: "قائمة واضحة ومراجعة كاملة لملف التأشيرة.",
    highlight: false,
  },
  {
    n: "3",
    title: "نحجز الموعد",
    desc: "موعد السفارة أو مركز التأشيرات ومتابعة الحالة.",
    highlight: false,
  },
  {
    n: "4",
    title: "الطيران والفندق",
    desc: "نحجز التذكرة والإقامة ضمن خطة واحدة.",
    highlight: false,
  },
  {
    n: "5",
    title: "استمتع برحلتك",
    desc: "متابعة معك من المغادرة حتى العودة.",
    highlight: true,
  },
];
...
const destinations = [
  {
    name: "إيطاليا",
    tag: "شنغن · سياحة وأعمال",
    image: "/assets/destinations/italy.jpg",
  },
  {
    name: "مالطا",
    tag: "شنغن · سياحة ودراسة",
    image: "/assets/destinations/malta.jpg",
  },
  {
    name: "فرنسا",
    tag: "شنغن · سياحة وعلاج",
...
const whyUs = [
  {
    title: "ملف واحد ومسؤول واحد",
    desc: "شخص واحد يتابع رحلتك من التأشيرة حتى العودة.",
  },
  {
    title: "شفافية كاملة",
    desc: "نوضح المطلوب والتكلفة والمدة مسبقاً، دون وعود بمنح التأشيرة.",
  },
  {
    title: "حضور محلي",
    desc: "مكتبنا في طرابلس ودعم على مدار الساعة بالهاتف وواتساب.",
  },
];

const testimonials = [
  {
    text: "جهّزوا لي ملف شنغن كامل وحجزوا الموعد في وقت قصير. المتابعة كانت يومية.",
    name: "أحمد م.",
    city: "طرابلس",
  },
  {
    text: "رحلة علاج لوالدي: نسّقوا المستشفى والإقامة والتذاكر. ارتحنا من التفاصيل.",
    name: "سلمى ع.",
    city: "بنغازي",
  },
  {
    text: "حجزنا برنامج عائلي لإستانبول بسعر واضح من البداية، بدون مفاجآت.",
    name: "خالد ب.",
    city: "مصراتة",
  },
];
...
export default function Home() {
  return (
    <div style={{ fontFamily: "var(--font-tajawal)" }}>
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(270deg,rgba(0,0,0,0.97) 20%,rgba(0,0,0,0.72) 55%,rgba(0,0,0,0.35) 100%)",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            من تجهيز ملف التأشيرة وحجز موعد السفارة، إلى تذكرة الطيران والفندق
            والبرنامج السياحي — نتابع معك كل خطوة حتى العودة.
          </p>
          <p
            style={{
              fontFamily: "var(--font-cairo)",
          ...
          >
            {["التأشيرة", "موعد السفارة", "المستندات", "الطيران", "الفندق"].map(
              (label) => (
            ...
            <span
              style={{
                ...
                borderRadius: 12,
                background:
                  "linear-gradient(120deg,rgba(240,212,154,0.24),rgba(195,154,76,0.18))",
        ...
        >
          {stats.map((s) => (
            ...
            >
              ...
              <div style={{ color: "#a3a3a3", fontSize: 15, marginTop: 4 }}>
                {s.label}
              </div>
            </div>
          ))}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <span
                style={{
                  ...
                  borderRadius: 999,
                  background: "#5ad18a",
                  boxShadow: "0 0 0 4px rgba(90,209,138,0.18)",
                }}
              />
              <VisitorCounter />
            </div>
            <div style={{ color: "#a3a3a3", fontSize: 15 }}>
              زائر للموقع منذ الإطلاق
            </div>
          </div>
        </div>
      </section>
      ...
      <section
        id="services"
        style={{ padding: "clamp(72px,8vw,120px) clamp(20px,4vw,56px) 0" }}
      >
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        ...iconBoxStyle,
                        background: "rgba(224,185,111,0.24)",
                        border: "1px solid rgba(224,185,111,0.55)",
                      }}
                    >
                      {s.icon}
                    </div>
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(250deg,rgba(0,0,0,0.96),rgba(20,20,20,0.86))",
            }}
          />
          <div
            style={{
          ...
          >
            <div>
              ...
              >
                أخبرنا بالدولة ونوع التأشيرة، ونتولى البحث عن أقرب موعد متاح
                وحجزه نيابة عنك.
              </p>
              <a
                href="#contact-form"
            ...
            >
              ...
              >
                نساعدك في تجهيز الملف وترتيب الموعد. قرار منح التأشيرة يعود
                للسفارة وحدها.
              </p>
            </div>
          </div>
      ...
      >
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          ...
          <p style={{ color: "#a3a3a3", fontSize: 19, margin: "0 0 44px" }}>
            تعرف في كل لحظة أين وصل ملفك ومن يتابعه.
          </p>
          <div
            style={{
              display: "grid",
              ...
              <div
                ...
                style={{
                  ...
                  background: s.highlight
                    ? "linear-gradient(150deg,#20190c,#121212)"
                    : "#151515",
                  border: s.highlight
                    ? "1px solid rgba(224,185,111,0.4)"
              ...
              >
                <span
                  style={{
                    ...
                    fontSize: 84,
                    color: s.highlight
                      ? "rgba(224,185,111,0.16)"
                      : "rgba(224,185,111,0.1)",
                    lineHeight: 1,
                  }}
                >
                  {s.n}
                ...
                <p
                  style={{
                    margin: 0,
                    color: s.highlight ? "#e2e2e2" : "#b3b3b3",
                    fontSize: 16,
                    lineHeight: 1.7,
                    position: "relative",
                  }}
        ...
        <div style={{ maxWidth: 1440, margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              <p style={{ color: "#a3a3a3", fontSize: 19, margin: 0 }}>
                شنغن، المملكة المتحدة، وأكثر من 40 دولة حول العالم.
              </p>
            </div>
            <a
              href="#contact-form"
              ...
              >
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(0deg,rgba(0,0,0,0.85) 0%,rgba(0,0,0,0.15) 55%,rgba(0,0,0,0.35) 100%)",
                  }}
                />
                <PlaneIcon
                  size={34}
            ...
            >
              {moreDestinations.map((d, i) => (
                ...
                >
                  ...
                  <span style={{ color: "#a3a3a3", fontSize: 15 }}>
                    {d.tag}
                  </span>
                </div>
              ))}
      ...
      >
        ...
        >
          ...
          >
            <Image
              src="/assets/zigo-pass.png"
              alt="بطاقة ZIGO Travel Pass"
              fill
              style={{ objectFit: "cover" }}
            />
          </div>
      ...
      >
        ...
        >
          <div>
            ...
            >
              اتصل بنا أو أرسل طلبك ونرد عليك خلال ساعات العمل، ونحن متاحون على
              مدار الساعة عبر واتساب.
            </p>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <a
            href="https://www.facebook.com/share/1EPNADeizY/?mibextid=wwXIfr"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/zigo.travel?igsi=MTU4bTBmZXYxb3hwZg%3D%3D"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.tiktok.com/@zigo.travel?_r=1&_t=ZS-996HPppdkCG"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TikTok"
            className="hover-bg-gold"
